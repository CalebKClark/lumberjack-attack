...
/**
 * In-game Yes/No sleep confirmation (avoids AWT dialogs under LWJGL).
 */
public final class GdxSleepPrompt implements SleepPrompt {
    ...
    public void draw(
        ...
        font.setColor(TEXT);
        layout.setText(font, "Go to sleep?");
        font.draw(
                batch,
                "Go to sleep?",
